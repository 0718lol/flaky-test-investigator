...
import AiTripPlannerModal from '../components/Trips/AiTripPlannerModal'
...
import {
  Plus, Edit2, Trash2, Archive, Copy, ArrowRight, MapPin, Sparkles,
  ...
  return (
    <>
            ...
            <section>
              <div className="sec-head">
                ...
                <div className="sec-tools">
                  ...
                  <button className="tool-action" onClick={() => setShowAiPlanner(true)} aria-label={t('dashboard.aiPlan')} title={t('dashboard.aiPlan')} style={{ width: 38, height: 38, borderRadius: 11 }}>
                    <Sparkles size={17} />
                  </button>
      ...
      <AiTripPlannerModal
        ...
        onCreated={(trip) => { setTrips(prev => [trip as DashboardTrip, ...prev]); navigate(`/trips/${trip.id}`) }}
      />
      {deleteTrip && (
        <ConfirmDialog
          isOpen={!!deleteTrip}
