...
const texts: Record<string, DemoTexts> = {
  de: {
    ...
    titleAfter: '',
    title: 'Willkommen zur Mancheng Demo',
    description:
  ...
  en: {
    ...
    titleAfter: '',
    title: 'Welcome to the Mancheng Demo',
  ...
  es: {
    ...
    titleAfter: '',
    title: 'Bienvenido a la demo de Mancheng',
  ...
  ar: {
    ...
    titleAfter: '',
    title: 'مرحبًا بك في النسخة التجريبية من Mancheng',
  ...
  id: {
    ...
    titleAfter: '',
    title: 'Selamat datang di Demo Mancheng',
    description:
    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
          ...
          >
            {t.titleBefore}
            <img src="/text-dark.svg" alt="漫程" style={{ height: 18 }} />
            {t.titleAfter}
          </h2>
        </div>
