...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Поділіться планом відпустки з іншими користувачами Mancheng',
  'vacay.owner': 'Власник',
  'vacay.shareEmailPlaceholder': 'Ел. пошта користувача Mancheng',
  ...
  'vacay.inviteHint': 'Запросіть іншого користувача Mancheng для спільного календаря відпусток.',
