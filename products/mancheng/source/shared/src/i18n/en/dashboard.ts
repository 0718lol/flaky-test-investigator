...
const dashboard: TranslationStrings = {
  ...
  'dashboard.aiPlan': 'Generate with AI',
  'dashboard.aiPlanTitle': 'Generate a trip with AI',
  'dashboard.aiPlanIntro': 'Enter the basics and AI will create an editable itinerary draft.',
  'dashboard.aiPlanHint': 'Places, opening hours and prices can change. Confirm important details before saving.',
  'dashboard.aiDestination': 'Destination',
  'dashboard.aiDestinationPlaceholder': 'e.g. Tokyo or Yunnan',
  'dashboard.aiTravelerCount': 'Travelers',
  'dashboard.aiBudget': 'Local activity budget (CNY)',
  'dashboard.aiBudgetPlaceholder': 'All travelers, optional',
  'dashboard.aiBudgetHint': 'Excludes travel to the destination and accommodation',
  'dashboard.aiTravelDetails': 'Arrival, stay and transport (optional)',
  'dashboard.aiArrivalTime': 'Arrival time (optional)',
  'dashboard.aiArrivalTimeHint': 'When you arrive at the destination airport or station',
  'dashboard.aiDepartureTime': 'Departure time (optional)',
  'dashboard.aiDepartureTimeHint': 'When you leave from the destination airport or station',
  'dashboard.aiBaseLocation': 'Accommodation (optional)',
  'dashboard.aiBaseLocationPlaceholder': 'Hotel name, address or nearby landmark',
  'dashboard.aiTransport': 'Main transport',
  'dashboard.aiTransportMixed': 'Flexible mix',
  'dashboard.aiTransportPublic': 'Public transit first',
  'dashboard.aiTransportWalking': 'Mostly walking',
  'dashboard.aiTransportTaxi': 'Taxi first',
  'dashboard.aiTransportDriving': 'Self-drive',
  'dashboard.aiInterests': 'Interests',
  'dashboard.aiInterestFood': 'Food',
  'dashboard.aiInterestCulture': 'History & culture',
  'dashboard.aiInterestNature': 'Nature',
  'dashboard.aiInterestShopping': 'Shopping',
  'dashboard.aiInterestFamily': 'Family',
  'dashboard.aiInterestArt': 'Art & exhibitions',
  'dashboard.aiInterestNightlife': 'Nightlife',
  'dashboard.aiInterestPhoto': 'Photography',
  'dashboard.aiInterestOutdoor': 'Outdoor activities',
  'dashboard.aiPace': 'Travel pace',
  'dashboard.aiPaceRelaxed': 'Relaxed',
  'dashboard.aiPaceBalanced': 'Balanced',
  'dashboard.aiPacePacked': 'Packed',
  'dashboard.aiRequirements': 'Extra requirements',
  'dashboard.aiRequirementsPlaceholder': 'e.g. Traveling with parents, no early starts, local food',
  'dashboard.aiGenerate': 'Generate itinerary',
  'dashboard.aiGenerating': 'Generating...',
  'dashboard.aiGenerateError': 'Could not generate the itinerary. Please try again.',
  'dashboard.aiRequired': 'Enter a destination, dates and a valid traveler count.',
  'dashboard.aiDateError': 'The end date cannot be before the start date.',
  'dashboard.aiTimeError': 'For a day trip, departure must be later than arrival.',
  'dashboard.aiPreviewTitle': 'Review AI itinerary draft',
  'dashboard.aiBackToForm': 'Edit details',
  'dashboard.aiSave': 'Save to Mancheng',
  'dashboard.aiSaveError': 'Could not save the itinerary. Please try again.',
  'dashboard.aiPlaces': 'places',
  'dashboard.aiNoPlaces': 'Nothing planned yet. You can add places after saving.',
  'dashboard.aiRegenerateDay': 'Regenerate this day',
  'dashboard.aiRegeneratingDay': 'Regenerating...',
  'dashboard.aiRegenerateDayConfirm': 'Regenerating will replace the current plan for this day. Continue?',
  'dashboard.aiRegenerateError': 'Could not regenerate this day. Please try again.',
  'dashboard.aiEditPlace': 'Edit place',
  'dashboard.aiDeletePlace': 'Delete place',
  'dashboard.aiMoveUp': 'Move up',
  'dashboard.aiMoveDown': 'Move down',
  'dashboard.aiAddPlace': 'Add place',
  'dashboard.aiPlaceName': 'Place name',
  'dashboard.aiStartTime': 'Suggested arrival time',
  'dashboard.aiDuration': 'Duration (minutes)',
  'dashboard.aiEstimatedCost': 'Estimated cost (all travelers/CNY)',
  'dashboard.aiAddress': 'Address',
  'dashboard.aiDescription': 'Recommendation and route notes',
  'dashboard.aiEditValidation': 'Enter a place name and a duration between 15 and 720 minutes.',
  'dashboard.aiMinutes': 'min',
  'dashboard.aiItineraryTitle': 'Itinerary title',
  'dashboard.aiItinerarySummary': 'Itinerary summary',
