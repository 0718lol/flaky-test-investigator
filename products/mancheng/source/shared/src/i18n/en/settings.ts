...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Travel companions for Mancheng',
  'settings.about.supporters.subtitle':
    "While you're planning your next route, these folks are helping plan Mancheng's future. Their monthly contribution goes straight into development and real hours spent — so Mancheng stays Open Source.",
  ...
  'settings.about.description':
    'Mancheng is a self-hosted AI travel planner that turns a few preferences into an editable day-by-day itinerary, with maps, budgets, packing lists and collaboration built in.',
  'settings.about.forkNotice':
    'Mancheng is an independent open-source fork based on TREK. The original project and its contributors remain credited under the AGPL-3.0 license.',
  'settings.about.upstream': 'TREK upstream project',
  ...
  'settings.airtrail.writeBackHint':
    'Off by default: AirTrail is the source of truth and Mancheng only reads from it. Turn on to push edits made in Mancheng back to AirTrail.',
