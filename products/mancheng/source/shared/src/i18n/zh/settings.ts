...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': '与漫程同行的伙伴',
  'settings.about.supporters.subtitle':
    '当你在规划下一段路线时，这些人也在一起规划漫程的未来。他们每月的支持直接用于开发与真实投入的时间——让漫程保持开源。',
  ...
  'settings.about.description':
    '漫程是一款自托管的 AI 旅行规划工具，只需填写少量偏好，即可生成可编辑的逐日行程，并继续使用地图、预算、行李清单与多人协作。',
  'settings.about.forkNotice':
    '漫程是基于 TREK 开发的独立开源分支，原项目及其贡献者依照 AGPL-3.0 许可证保留署名。',
  'settings.about.upstream': 'TREK 上游项目',
  ...
  'settings.airtrail.writeBackHint':
    '默认关闭：AirTrail 是数据来源，漫程仅从中读取。开启后会将在漫程中所做的修改写回 AirTrail。',
