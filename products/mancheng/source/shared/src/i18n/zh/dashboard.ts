...
const dashboard: TranslationStrings = {
  ...
  'dashboard.aiPlan': 'AI 生成行程',
  'dashboard.aiPlanTitle': 'AI 生成旅行计划',
  'dashboard.aiPlanIntro': '填写基本旅行条件，AI 会生成一份可以继续编辑的行程草稿。',
  'dashboard.aiPlanHint': '地点、营业时间和费用可能变化，保存前请确认重要信息。',
  'dashboard.aiDestination': '目的地',
  'dashboard.aiDestinationPlaceholder': '例如：东京、云南大理',
  'dashboard.aiTravelerCount': '出行人数',
  'dashboard.aiBudget': '当地游玩总预算（人民币）',
  'dashboard.aiBudgetPlaceholder': '全部人员合计，可选',
  'dashboard.aiBudgetHint': '不含往返交通和住宿',
  'dashboard.aiTravelDetails': '到离与交通（选填）',
  'dashboard.aiArrivalTime': '到达时间（选填）',
  'dashboard.aiArrivalTimeHint': '到达目的地机场或车站的时间',
  'dashboard.aiDepartureTime': '离开时间（选填）',
  'dashboard.aiDepartureTimeHint': '从目的地机场或车站出发的时间',
  'dashboard.aiBaseLocation': '住宿位置（选填）',
  'dashboard.aiBaseLocationPlaceholder': '酒店名称、地址或附近地标',
  'dashboard.aiTransport': '主要交通方式',
  'dashboard.aiTransportMixed': '灵活混合',
  'dashboard.aiTransportPublic': '公共交通优先',
  'dashboard.aiTransportWalking': '步行为主',
  'dashboard.aiTransportTaxi': '打车优先',
  'dashboard.aiTransportDriving': '自驾',
  'dashboard.aiInterests': '兴趣偏好',
  'dashboard.aiInterestFood': '美食',
  'dashboard.aiInterestCulture': '历史文化',
  'dashboard.aiInterestNature': '自然风光',
  'dashboard.aiInterestShopping': '购物',
  'dashboard.aiInterestFamily': '亲子',
  'dashboard.aiInterestArt': '艺术展览',
  'dashboard.aiInterestNightlife': '夜生活',
  'dashboard.aiInterestPhoto': '拍照打卡',
  'dashboard.aiInterestOutdoor': '户外活动',
  'dashboard.aiPace': '旅行节奏',
  'dashboard.aiPaceRelaxed': '轻松',
  'dashboard.aiPaceBalanced': '适中',
  'dashboard.aiPacePacked': '紧凑',
  'dashboard.aiRequirements': '补充要求',
  'dashboard.aiRequirementsPlaceholder': '例如：带老人，不要安排太早，想多吃当地特色',
  'dashboard.aiGenerate': '生成行程',
  'dashboard.aiGenerating': '正在生成...',
  'dashboard.aiGenerateError': '生成行程失败，请稍后重试',
  'dashboard.aiRequired': '请填写目的地、日期和正确的出行人数',
  'dashboard.aiDateError': '结束日期不能早于开始日期',
  'dashboard.aiTimeError': '同日往返时，离开时间必须晚于到达时间',
  'dashboard.aiPreviewTitle': '确认 AI 行程草稿',
  'dashboard.aiBackToForm': '返回修改',
  'dashboard.aiSave': '保存到漫程',
  'dashboard.aiSaveError': '保存行程失败，请稍后重试',
  'dashboard.aiPlaces': '个地点',
  'dashboard.aiNoPlaces': '这一天暂时没有安排，可以保存后继续添加。',
  'dashboard.aiRegenerateDay': '重新生成当天',
  'dashboard.aiRegeneratingDay': '正在重新生成...',
  'dashboard.aiRegenerateDayConfirm': '重新生成会替换这一天当前的安排，继续吗？',
  'dashboard.aiRegenerateError': '重新生成当天行程失败，请稍后重试',
  'dashboard.aiEditPlace': '编辑地点',
  'dashboard.aiDeletePlace': '删除地点',
  'dashboard.aiMoveUp': '向上移动',
  'dashboard.aiMoveDown': '向下移动',
  'dashboard.aiAddPlace': '添加地点',
  'dashboard.aiPlaceName': '地点名称',
  'dashboard.aiStartTime': '建议到达时间',
  'dashboard.aiDuration': '停留时长（分钟）',
  'dashboard.aiEstimatedCost': '预计费用（全部人员/人民币）',
  'dashboard.aiAddress': '地址',
  'dashboard.aiDescription': '推荐理由和衔接建议',
  'dashboard.aiEditValidation': '请填写地点名称，并将停留时长设为 15 至 720 分钟',
  'dashboard.aiMinutes': '分钟',
  'dashboard.aiItineraryTitle': '行程标题',
  'dashboard.aiItinerarySummary': '行程概览',
