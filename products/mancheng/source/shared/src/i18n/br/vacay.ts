...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Compartilhe seu plano de férias com outros usuários do Mancheng',
  'vacay.owner': 'Proprietário',
  'vacay.shareEmailPlaceholder': 'E-mail do usuário Mancheng',
  ...
  'vacay.inviteHint': 'Convide outro usuário Mancheng para compartilhar um calendário de férias combinado.',
