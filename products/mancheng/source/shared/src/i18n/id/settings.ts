...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Rekan perjalanan untuk Mancheng',
  'settings.about.supporters.subtitle':
    'Saat kamu merencanakan rute berikutnya, orang-orang ini ikut merencanakan masa depan Mancheng. Kontribusi bulanan mereka langsung masuk ke pengembangan dan jam kerja nyata — supaya Mancheng tetap Open Source.',
  ...
  'settings.about.description':
    'Mancheng adalah perencana perjalanan self-hosted yang membantu kamu mengatur perjalanan dari ide pertama hingga kenangan terakhir. Perencanaan harian, anggaran, daftar bawaan, foto dan masih banyak lagi — semua di satu tempat, di servermu sendiri.',
  ...
  'settings.airtrail.writeBackHint':
    'Nonaktif secara bawaan: AirTrail adalah sumber kebenaran dan Mancheng hanya membaca darinya. Aktifkan untuk mengirim perubahan yang dibuat di Mancheng kembali ke AirTrail.',
