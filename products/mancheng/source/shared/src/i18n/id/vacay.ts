...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Bagikan rencana cuti kamu dengan pengguna Mancheng lainnya',
  'vacay.owner': 'Pemilik',
  'vacay.shareEmailPlaceholder': 'Email pengguna Mancheng',
  ...
  'vacay.inviteHint': 'Undang pengguna Mancheng lain untuk berbagi kalender cuti bersama.',
