...
const login: TranslationStrings = {
  ...
  'login.createAdminHint': 'Configurez le premier compte administrateur pour Mancheng.',
  ...
  'login.insecureCookie.body':
    'You’re connecting over plain HTTP, so your browser drops Mancheng’s secure session cookie — the next request fails with "Access token required". Fix: use HTTPS, or for a home-lab set COOKIE_SECURE=false.',
