...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': "Partagez votre plan de vacances avec d'autres utilisateurs Mancheng",
  'vacay.owner': 'Propriétaire',
  'vacay.shareEmailPlaceholder': "E-mail de l'utilisateur Mancheng",
  ...
  'vacay.inviteHint': 'Invitez un autre utilisateur Mancheng à partager un calendrier de vacances combiné.',
