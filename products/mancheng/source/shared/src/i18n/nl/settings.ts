...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Reisgezelschap voor Mancheng',
  'settings.about.supporters.subtitle':
    'Terwijl jij je volgende route plant, plannen deze mensen mee aan de toekomst van Mancheng. Hun maandelijkse bijdrage gaat rechtstreeks naar ontwikkeling en echte uren — zodat Mancheng Open Source blijft.',
  ...
  'settings.about.description':
    "Mancheng is een zelf-gehoste reisplanner die je helpt je reizen te organiseren van het eerste idee tot de laatste herinnering. Dagplanning, budget, paklijsten, foto's en nog veel meer — alles op één plek, op je eigen server.",
  ...
  'settings.airtrail.writeBackHint':
    'Standaard uit: AirTrail is de bron van waarheid en Mancheng leest er alleen uit. Schakel in om in Mancheng gemaakte wijzigingen terug te sturen naar AirTrail.',
