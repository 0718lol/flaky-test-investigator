...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Manchengの旅仲間',
  'settings.about.supporters.subtitle': '皆さんの支援がManchengの未来を支えています。',
  ...
  'settings.about.description': 'Manchengはセルフホスト型の旅行プランナーです。',
  ...
  'settings.airtrail.writeBackHint':
    '既定ではオフ: AirTrail が信頼できる情報源で、Mancheng は読み取りのみを行います。Mancheng で行った編集を AirTrail に書き戻すにはオンにします。',
