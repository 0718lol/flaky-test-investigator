...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Mancheng için seyahat Arkadaşları',
  ...
  'settings.about.description':
    'Mancheng, seyahatlerinizi ilk fikirden son anıya kadar organize etmenize yardımcı olan, kendi kendine barındırılan bir seyahat planlayıcıdır. Gün planlaması, bütçe, paketleme listeleri, fotoğraflar ve çok daha fazlası; hepsi tek bir yerde, kendi sunucunuzda.',
  ...
  'settings.airtrail.writeBackHint':
    'Varsayılan olarak kapalı: AirTrail asıl kaynaktır ve Mancheng yalnızca okur. Mancheng’te yapılan değişiklikleri AirTrail’e geri göndermek için açın.',
