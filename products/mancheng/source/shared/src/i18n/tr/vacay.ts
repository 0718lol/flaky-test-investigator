...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Tatil planınızı diğer Mancheng kullanıcılarıyla paylaşın',
  'vacay.owner': 'Mal sahibi',
  'vacay.shareEmailPlaceholder': 'Mancheng kullanıcısının e-postası',
  ...
  'vacay.inviteHint': 'Başka bir Mancheng kullanıcısını birleşik bir tatil takvimini paylaşmaya davet edin.',
