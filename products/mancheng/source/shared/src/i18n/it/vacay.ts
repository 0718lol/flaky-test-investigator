...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Condividi il tuo piano ferie con altri utenti Mancheng',
  'vacay.owner': 'Proprietario',
  'vacay.shareEmailPlaceholder': "Email dell'utente Mancheng",
  ...
  'vacay.inviteHint': 'Invita un altro utente Mancheng a condividere un calendario ferie combinato.',
